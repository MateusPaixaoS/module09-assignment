...
print("1. Focus on high-performing products like PhoneX to maximize revenue.")
print("2. Increase promotions for high-margin categories since promo sales show strong returns.")
print("3. Address missing data issues in Unit_Price and Units to improve analysis accuracy.")